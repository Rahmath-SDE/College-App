...
fun StudentSidebarDrawer(
    ...
    ModalNavigationDrawer(
        ...
        drawerContent = {
            ModalDrawerSheet(
                drawerContainerColor = Color(0xFFBDE8C0).copy(alpha = 0.9f), // elegant pastel green
                ...
                NavigationDrawerItem(
                    label = { Text("About", fontSize = 16.sp, fontWeight = FontWeight.Medium) },
                    selected = false,
                    onClick = {
                        Toast.makeText(
                            context,
                ...
                NavigationDrawerItem(
                    label = { Text("Help", fontSize = 16.sp, fontWeight = FontWeight.Medium) },
                    selected = false,
                    onClick = {
                        Toast.makeText(
                            context,
